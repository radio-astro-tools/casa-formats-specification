...
meta:
    id: tiled_column_storage_manager
    title: Casacore Table Data System StandardColumnStMan layout
    application:
      - casacore
      - AIPS++
      - CASA
...
types:
  ...
  sub_record_description:
        seq:
          ...
          - id: value
            doc: | 
              "This won't work completely as is. All the types are not defined."
            type:
                switch-on: type
                cases:
                  0:  string                 # bool
